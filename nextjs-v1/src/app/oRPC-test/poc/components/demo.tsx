...
} from "@/lib/oRPC/clients/orpc";

// client/nextjs-v1/src/lib/oRPC_node_server/clients/orpc.ts
// interface TodoFormValues {
//   title: string;
//   description: string;
// }
// new api! in oRPC_node_server
// export type TodoFormValues = ApiInputs["auth"]["login"];
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive flex w-full min-w-0 rounded-md border bg-transparent px-3 py-2 text-base shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
              />
            </div>
          </CardContent>
          <CardFooter>
